...
#define DEFAULT_FWHM_MAX           5.0
#define DEFAULT_FWHM_MIN           0.1
#define DEFAULT_ECCENTRICITY_MAX   0.75
#define DEFAULT_SNR_MIN            1.0
#define DEFAULT_STAR_RESIDUAL_MAX  0.20
#define DEFAULT_STARS_MIN          10
#define DEFAULT_NOISE_MAX          0.1
#define DEFAULT_MEDIAN_MIN         0.0001
#define DEFAULT_MEDIAN_MAX         0.95
...
function SSPParameters()
{
   ...
   this.reset = function()
   {
      ...
      this.useFWHM=true;this.useEccentricity=true;this.useSNR=false;
      this.useStarResidual=false;this.useStars=false;this.useNoise=false;this.useMedian=false;
      this.keepPercentage=DEFAULT_KEEP_PERCENTAGE;
