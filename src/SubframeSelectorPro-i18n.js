...
function SSPi18n()
{
   ...
   this.strings = {
      ...
      PLATE_SCALE_TITLE: [
         ...
         "Scala immagine (arcsec/px) (opzionale)",
      ...
      PSF_UPPER_LIMIT: [
         "Upper Limit (DN):", "Limite superiore (DN):", "Límite superior (DN):",
         "Obergrenze (DN):", "Limite supérieur (DN) :"
      ],
      ...
      BTN_RESET:  ["Reset",  "Reimposta", "Restablecer", "Zurücksetzen", "Réinitialiser"],
      ...
      FOLDER_SCORE_TITLE: [
         "Folder Quality Assessment","Valutazione qualità cartella","Evaluacion de calidad de carpeta","Ordnerqualitatsbeurteilung","Evaluation de la qualité du dossier"
      ],
      FOLDER_SCORE_EMPTY: [
         "Run analysis to see folder quality score...","Esegui l'analisi per vedere il punteggio della cartella...","Ejecute el analisis para ver el puntaje de la carpeta...","Analyse starten um den Ordnerqualitatswert zu sehen...","Lancer l'analyse pour voir le score de qualite du dossier..."
      ]
   };
