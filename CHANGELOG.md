...
- CSV report export (16 columns) with Folder Quality Score summary block
...
- Click on graph or double-click on table row to open image in PixInsight
- Folder Quality Assessment (composite score 0-1 and letter grade A-F)
- Extended Statistics Panel with separate stats for accepted and rejected frames (CV included)
- Rejection reason tooltips in the measurements table
- `Upper Limit` parameter for PSF star detection saturation control
